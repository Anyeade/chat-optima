...
import type { ArtifactToolbarItem, ArtifactToolbarContext } from './create-artifact';
...
const Tool = ({
  ...
  const handleSelect = () => {
    ...
    if (selectedTool !== description) {
      ...
      onClick({ appendMessage: append, metadata, setMetadata });
    }
  };
  ...
  return (
    ...
    >
        ...
        {isToolbarVisible &&
          secondaryTools.map((secondaryTool) => (
            <Tool
              ...
              onClick={(context) => secondaryTool.onClick(context)}
            />
          ))}
      </AnimatePresence>
      ...
      <Tool
        ...
        metadata={metadata}
        setMetadata={setMetadata}
        onClick={(context) => primaryTool.onClick(context)}
      />
    </motion.div>
  );
};
