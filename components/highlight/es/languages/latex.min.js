...
const hljsGrammar=(()=>{return e=>{const a=[{begin:/\^{6}[0-9a-f]{6}/
},{begin:/\^{5}[0-9a-f]{5}/},{begin:/\^{4}[0-9a-f]{4}/},{
begin:/\^{3}[0-9a-f]{3}/},{begin:/\^{2}[0-9a-f]{2}/},{
begin:/\^{2}[\u0000-\u007f]/}];
const n=[{className:"keyword",begin:/\\/,relevance:0,
...
const l=[r];
const o=(e,a)=>({
contains:[s],starts:{relevance:0,contains:e,starts:a}});
const d=(e,a)=>({
begin:`\\\\${e}(?![a-zA-Z@:_])`,keywords:{$pattern:/\\[a-zA-Z]+/,keyword:`\\${e}`
},relevance:0,contains:[s],starts:a});
const m=(a,n)=>e.inherit({
begin:`\\\\begin(?=[ \t]*(\\r?\\n[ \t]*)?\\{${a}\\})`,keywords:{
$pattern:/\\[a-zA-Z]+/,keyword:"\\begin"},relevance:0
},o(c,n));
const g=(a="string")=>e.END_SAME_AS_BEGIN({className:a,begin:/(.|\r?\n)/,
