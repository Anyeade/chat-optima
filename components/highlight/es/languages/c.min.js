...
const s="[a-zA-Z_]\\w*::";
const r=`(${a}|${n.optional(s)}[a-zA-Z_]\\w*${n.optional("<[^<>]+>")})`;
const i={
...
const u=[c,i,t,e.C_BLOCK_COMMENT_MODE,o,l];
const g={variants:[{begin:/=/,end:/;/},{
begin:/\(/,end:/\)/},{beginKeywords:"new throw return else",end:/;/}],
keywords:m,contains:u.concat([{begin:/\(/,end:/\)/,keywords:m,
contains:u.concat(["self"]),relevance:0}]),relevance:0};
const p={
