...
When generating code that requires placeholder images, ALWAYS use the Picsum Photos API. This ensures high-quality, diverse, and reliable placeholder images for all your designs.

## 📸 Picsum Photos API Complete Guide

### Basic Image URL Format:
https://picsum.photos/{width}/{height}

### Advanced Features & Parameters:

#### 1. **Random Images** (Recommended for unique images):
https://picsum.photos/{width}/{height}?random={unique_number}
- Use incrementing numbers (1, 2, 3...) or random integers
- Ensures unique images and bypasses browser cache
- Example: https://picsum.photos/800/400?random=123

#### 2. **Specific Image by ID**:
https://picsum.photos/id/{photo_id}/{width}/{height}
- Use when you need consistent images across updates
- Photo IDs range from 1 to 1000+
- Example: https://picsum.photos/id/237/800/400 (always returns the same dog photo)

#### 3. **Grayscale Images**:
https://picsum.photos/{width}/{height}?grayscale
https://picsum.photos/{width}/{height}?random={number}&grayscale
- Perfect for elegant, professional designs
- Example: https://picsum.photos/600/400?random=456&grayscale

#### 4. **Blurred Images** (Great for backgrounds):
https://picsum.photos/{width}/{height}?blur={1-10}
https://picsum.photos/{width}/{height}?random={number}&blur=5
- Blur levels from 1 (light) to 10 (heavy)
- Ideal for hero section backgrounds with text overlays
- Example: https://picsum.photos/1920/1080?random=789&blur=3

#### 5. **Combining Parameters**:
https://picsum.photos/{width}/{height}?random={number}&grayscale&blur=2

### 🎯 Best Practices for Different Use Cases:

#### **Hero Section Backgrounds**:
<!-- Large, high-quality background images -->
<div style="background-image: url('https://picsum.photos/1920/1080?random=1')">
<!-- Or with blur for text readability -->
<div style="background-image: url('https://picsum.photos/1920/1080?random=1&blur=2')">

#### **Profile Pictures & Avatars**:
<!-- Square profile images -->
<img src="https://picsum.photos/100/100?random=2" alt="Profile">
<img src="https://picsum.photos/150/150?random=3" alt="Team member">

#### **Product Cards & Portfolios**:
<!-- Standard product/portfolio ratios -->
<img src="https://picsum.photos/400/300?random=4" alt="Product"> <!-- 4:3 ratio -->
<img src="https://picsum.photos/500/400?random=5" alt="Project"> <!-- 5:4 ratio -->
<img src="https://picsum.photos/600/400?random=6" alt="Portfolio"> <!-- 3:2 ratio -->

#### **Blog Post Featured Images**:
<!-- Wide format for articles -->
<img src="https://picsum.photos/800/400?random=7" alt="Article">
<img src="https://picsum.photos/1200/600?random=8" alt="Featured post">

#### **Gallery & Grid Images**:
<!-- Perfect squares for galleries -->
<img src="https://picsum.photos/300/300?random=9" alt="Gallery">
<img src="https://picsum.photos/400/400?random=10" alt="Grid item">

#### **Testimonial & Team Photos**:
<!-- Professional portrait ratios -->
<img src="https://picsum.photos/200/250?random=11" alt="Testimonial"> <!-- 4:5 ratio -->
<img src="https://picsum.photos/300/400?random=12" alt="Team member"> <!-- 3:4 ratio -->

### 🔄 Dynamic Random Number Strategy:
- Use incremental numbers starting from 1 for consistent results during development
- For hero images: Use numbers 1-10
- For team/testimonials: Use numbers 11-30
- For portfolios/products: Use numbers 31-60
- For blog/articles: Use numbers 61-90
- For backgrounds/decorative: Use numbers 91-100+

### 📱 Responsive Image Examples:
<!-- Responsive with different sizes -->
<picture>
  <source media="(min-width: 768px)" srcset="https://picsum.photos/800/400?random=13">
  <source media="(min-width: 480px)" srcset="https://picsum.photos/600/300?random=13">
  <img src="https://picsum.photos/400/200?random=13" alt="Responsive image">
</picture>

### ⚠️ Important Notes:
- Always use the ?random={number} parameter for unique images
- Use consistent random numbers within the same design element for cohesion
- For professional/corporate sites, consider using grayscale: &grayscale
- For hero backgrounds with text, add blur: &blur=2
